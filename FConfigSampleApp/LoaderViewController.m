...
- (void)zigzagButton
{
    self.resetButton.transform = CGAffineTransformRotate(CGAffineTransformIdentity, degreesToRadians(15));
...
- (void)addResetButton
{
    ...
    self.resetButton.frame = CGRectMake(160.0f, 200.0f, 120.0f, 30.0f);
    [self.resetButton setTitle:@"Reset" forState:UIControlStateNormal];
    [self.resetButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [self.resetButton setBackgroundImage:[ConfigUtility imageGradientColorDefaultForBounds:self.resetButton.bounds] forState:UIControlStateNormal];
...
- (void)resetButtonPressed {
    ...
    [[FConfig sharedInstance] resetState];
}
...
- (void)addConstraints
{
    ...
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:self.resetButton attribute:NSLayoutAttributeCenterX relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeCenterX multiplier:1.f constant:0.f]];
    ...
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:self.resetButton attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:self.fetchStatusLabel attribute:NSLayoutAttributeBottom multiplier:1.f constant:10.f]];
    ...
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:self.resetButton attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1.f constant:120.f]];
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:self.resetButton attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1.f constant:30.f]];
